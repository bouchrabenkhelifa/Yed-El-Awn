        ...
        <body>
            <div class='  ml-80 flex items-center justify-center'>
                <div class='bg-white shadow-lg rounded-lg p-6 w-full max-w-3xl ml-auto mr-40'>
                    ...
                    <form action='../Pages/GestionMembres.php' method='POST' enctype='multipart/form-data' class='grid grid-cols-2 gap-6'>
                        ...
                        <div class='col-span-1'>
                            <label for='adresse' class='block text-gray-700 font-medium mb-2'>Adresse</label>  <!-- Fixed here -->
                        ...
                        <div class='col-span-1'>
                          ...
                          <input type='password' name='motdepasse' id='motdepasse' placeholder='Mot de passe' class='w-full border-2 border-gray-100 p-2 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500' required>
                        </div>
