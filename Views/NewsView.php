...
class NewsView {
    public function afficher($News) {
        ...
        echo "<div class='flex justify-center min-h-screen'>";
        echo "    <div class='container max-w-4xl px-2 py-4'>";
        
        echo "        <h1 class='text-xl font-bold text-center mb-6' style='color: #F17228'>Nouvelles & Evenements</h1>";
        ...
        foreach ($News as $nouvelle) {
            ...
            echo "            <h2 class='text-lg font-semibold mt-1 mb-2' style='color: #F17228'>" . 
            ...
            echo "            <a href='#' class='inline-block px-4 py-1 text-sm rounded-full text-white' 
                             style='background-color: #F17228'>Lire plus</a>";
            echo "        </div>";
            echo "    </div>";
            echo "</div>";
        }
